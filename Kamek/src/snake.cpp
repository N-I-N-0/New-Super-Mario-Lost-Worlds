...
dActor_c *daSnake_c::build() {
	void *buffer = AllocFromGameHeap1(sizeof(daSnake_c));
	return new(buffer) daSnake_c;
}
...
////////////////////////
	...
	void daSnake_c::playerCollision(ActivePhysics *apThis, ActivePhysics *apOther) {
	...
	void daSnake_c::yoshiCollision(ActivePhysics *apThis, ActivePhysics *apOther) {
		this->playerCollision(apThis, apOther);
	}

	bool daSnake_c::collisionCatD_Drill(ActivePhysics *apThis, ActivePhysics *apOther) {
	...
	bool daSnake_c::collisionCat7_GroundPound(ActivePhysics *apThis, ActivePhysics *apOther) {
		this->collisionCatD_Drill(apThis, apOther);
		return true;
	}

	bool daSnake_c::collisionCat7_GroundPoundYoshi(ActivePhysics *apThis, ActivePhysics *apOther) {
		this->collisionCatD_Drill(apThis, apOther);
		return true;
	}

	bool daSnake_c::collisionCat9_RollingObject(ActivePhysics *apThis, ActivePhysics *apOther) {
	...
	bool daSnake_c::collisionCat3_StarPower(ActivePhysics *apThis, ActivePhysics *apOther){
		doStateChange(&StateID_Die);
		return true;
	}

	bool daSnake_c::collisionCat13_Hammer(ActivePhysics *apThis, ActivePhysics *apOther) {
		doStateChange(&StateID_Die);
		return true;
	}

	bool daSnake_c::collisionCatA_PenguinMario(ActivePhysics *apThis, ActivePhysics *apOther){
		backFire = apOther->owner->direction ^ 1;
		doStateChange(&StateID_KnockBack);
		return true;
	}

	bool daSnake_c::collisionCat14_YoshiFire(ActivePhysics *apThis, ActivePhysics *apOther){
		backFire = apOther->owner->direction ^ 1;
		doStateChange(&StateID_KnockBack);
		return true;
	}

	bool daSnake_c::collisionCat1_Fireball_E_Explosion(ActivePhysics *apThis, ActivePhysics *apOther) {
		backFire = apOther->owner->direction ^ 1;
		doStateChange(&StateID_KnockBack);
		return true;
	}

	// void daSnake_c::collisionCat2_IceBall_15_YoshiIce(ActivePhysics *apThis, ActivePhysics *apOther) {
	// 	doStateChange(&StateID_DieFall);
	// }

	// These handle the ice crap
	void daSnake_c::_vf148() {
		dEn_c::_vf148();
		doStateChange(&StateID_Die);
	}
	void daSnake_c::_vf14C() {
		dEn_c::_vf14C();
		doStateChange(&StateID_Die);
	}
	...
	bool daSnake_c::CreateIceActors()
	{
	...
	void daSnake_c::addScoreWhenHit(void *other) {}


bool daSnake_c::calculateTileCollisions() {
...
void daSnake_c::bindAnimChr_and_setUpdateRate(const char* name, int unk, float unk2, float rate) {
