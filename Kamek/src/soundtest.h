#ifndef __SOUNTTEST_H
#define __SOUNTTEST_H
...
class dScSoundTest_c : public dScene_c {
	public:
		dScSoundTest_c();
		...
		u32 selectedSFX;
		bool currentSFXHandle;

		nw4r::snd::SoundHandle handles[2];
		...
		static dScSoundTest_c *build();
		static dScSoundTest_c *instance;
