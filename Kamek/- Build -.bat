...
:kamek
py -3 tools/kamek.py NSMLW.yaml --no-rels --use-mw --gcc-type=powerpc-eabi --gcc-path=tools\devkitPPC\bin --gcc-append-exe --mw-path=tools --fast-hack
...
:move
move "%~dp0\Build\*" "%NSMLW%\NSMLW\Code" >nul
